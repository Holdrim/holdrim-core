...
const DENIED = [
  ...
  { prefix: 'engine/web/generated/',
    why: 'the local Mermaid chunks are generated by build:web from the same panel sources and ' +
      'the pinned vendor package; scanning minified vendor output repeats those sources' },
