...
request's tier done (`CONTRIBUTING.md`, "And the six lenses") with no open CRITICAL or MAJOR; no
merge conflict; the pull request names its kind, tier and the agent that made it. Squash, with a
